...
class PhoneVoteDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function (PhoneVote $model){
                return view('admin.pages.vote.phone.action', compact('model'));
            })
            ->editColumn('photo', function(PhoneVote $model) {
                return '<img src="/files/' .base64_encode($model->photo) .'"/>';
            })
            ->editColumn('closing_date', function(PhoneVote $model) {
                return $model->closing_date ?? 'Not set';
            })
            ->editColumn('draw_date', function(PhoneVote $model) {
                return $model->draw_date ?? 'Not set';
            })
            ->editColumn('vote_progress', function(PhoneVote $model) {
            ...
            ->editColumn('purchase_progress', function(PhoneVote $model) {
            ...
            ->addColumn('status', function (PhoneVote $model){
     ...
     */
    public function query(PhoneVote $model): QueryBuilder
    {
